...
pub struct BotState {
    ...
    pub user_rasterize_svg: Mutex<HashMap<UserId, bool>>,
    pub user_force_ocr: Mutex<HashMap<UserId, bool>>,
...
impl BotState {
    pub fn new(bridge: PythonBridge, config: Config) -> Self {
        Self {
            ...
            user_rasterize_svg: Mutex::new(HashMap::new()),
            user_force_ocr: Mutex::new(HashMap::new()),
